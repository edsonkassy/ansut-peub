...
<head>
    ...
    <title>Candidature reçue - PEUB</title>
</head>
        ...
        <tr>
            <td style="color: #374151; font-size: 16px; line-height: 1.6;">
                <p style="margin: 0 0 16px 0;">
                    Bonjour <strong>{{ $bachelier->prenoms }}</strong>,
                </p>
                
                <p style="margin: 0 0 16px 0;">
                    Votre candidature au programme PEUB a bien été reçue.
                </p>
                
                <p style="margin: 0 0 24px 0; color: #6B7280; font-size: 14px;">
                    Notre équipe examinera votre profil sous 24-48 heures.<br>
                    Vous recevrez un email de confirmation une fois votre compte validé.
                </p>
                
                <!-- Bouton simple -->
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ route('auth.pending-validation') }}" 
