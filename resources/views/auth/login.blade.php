    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Connectez-vous avec votre méthode préférée
            </p>
        </div>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3">
                ...
                <!-- Microsoft -->
                <a href="{{ route('auth.social.redirect', ['provider' => 'microsoft']) }}" 
                   class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors">
                ...
                <!-- LinkedIn -->
                <a href="{{ route('auth.social.redirect', ['provider' => 'linkedin']) }}" 
                   class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    Vous êtes un nouveau bachelier ?
                    <a href="{{ route('auth.register') }}" class="font-medium text-primary-600 hover:text-primary-700">
                        S'inscrire ici
                    </a>
                </p>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-4">
                    ...
                    <div class="mt-2 text-sm text-cyan-800">
                        <p>Choisissez votre méthode de connexion préférée pour accéder à votre espace PEUB et découvrir toutes les opportunités qui s'offrent à vous.</p>
                    </div>
                </div>
            </div>
        </div>
