        ...
        <div class="bg-white border border-gray-200 mb-8">
            <div class=" p-6">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-gray-900">Créer une opportunité</h1>
                </div>
                <p class="text-gray-600 mt-1">Publiez une nouvelle offre pour attirer des candidats</p>
            </div>
            
            <form action="{{ route('partenaire.opportunites.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div id="type-cards" class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <button type="button" data-type="bourse" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="stage" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="emploi" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="formation" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="concours" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="event" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <button type="button" data-type="promotion" class="type-card group border border-gray-300 bg-white p-4 flex flex-col items-center cursor-pointer focus:outline-none transition-all">
                        ...
                        <div>
                            <div class="border border-gray-300 p-4 bg-gray-50">
                                <div class="flex items-center justify-center h-48">
                                    <div id="placeholder-container" class="flex flex-col items-center justify-center text-gray-400">
                                        <i data-lucide="image" class="w-12 h-12 mb-2"></i>
                                        <span class="text-sm">Aucune image sélectionnée</span>
                                    </div>
                                    <img id="preview-image" src="" alt="Aperçu" class="max-h-48 w-auto object-contain hidden">
                                </div>
                            </div>
                        </div>
                        <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" 
                              class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm" required>{{ old('description') }}</textarea>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="nombre_places" id="nombre_places" value="{{ old('nombre_places') }}" min="1"
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="remuneration" id="remuneration" value="{{ old('remuneration') }}" 
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="date" name="date_debut" id="date_debut" value="{{ old('date_debut') }}" min="{{ date('Y-m-d') }}"
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_fin" id="date_fin" value="{{ old('date_fin') }}" min="{{ date('Y-m-d') }}"
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_limite_candidature" id="date_limite_candidature" value="{{ old('date_limite_candidature') }}" min="{{ date('Y-m-d') }}"
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm" required>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="competences_requises" id="competences_requises" value="{{ old('competences_requises') }}" 
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="criteres_eligibilite" id="criteres_eligibilite" value="{{ old('criteres_eligibilite') }}" 
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="documents_requis" id="documents_requis" value="{{ old('documents_requis') }}" 
                                   class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div>
                        ...
                        <input type="url" name="lien_externe" id="lien_externe" value="{{ old('lien_externe') }}" 
                               class="block w-full py-3 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('partenaire.opportunites.index') }}" 
                           class="inline-flex items-center px-4 py-2 border border-gray-300 text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                            Annuler
                        </a>
                        <button type="submit" 
                                class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
