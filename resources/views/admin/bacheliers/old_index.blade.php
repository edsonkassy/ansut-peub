        ...
        <table class="min-w-full">
            <thead class="bg-gray-50 border-b-2 border-gray-200">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bac</th>
            ...
            <tbody class="bg-white divide-y-2 divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">Série {{ $bachelier->serie_bac }}</div>
                        <div class="text-sm text-gray-500">
                            {{ number_format($bachelier->note_bac, 2) }}/20
